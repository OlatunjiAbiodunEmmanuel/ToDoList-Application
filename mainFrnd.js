function collectFrnd() {
    ...
    document.getElementById('fos').appendChild(list);
    ...
    Number(document.getElementById('fid').innerHTML) + 1;
    document.getElementById('fid').style.display = 'inLine';
    document.getElementById('fid').style.backgroundColor = '#1877f2';
    document.getElementById('fid').style.color = 'white';
    ...
    document.getElementById('feb').style.backgroundColor = '#1877f2';
    document.getElementById('feb').style.color = 'white';
    document.getElementById('readfid').style.display = 'inLine';
  ...
  function frnd() {
    ...
    document.getElementById('frndList').style.display = 'block';
