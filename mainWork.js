function collectWork() {
    ...
    document.getElementById('wos').appendChild(list);
    ...
    Number(document.getElementById('wid').innerHTML) + 1;
    document.getElementById('wid').style.display = 'inLine';
    document.getElementById('wid').style.backgroundColor = '#1877f2';
    document.getElementById('wid').style.color = 'white';
    ...
    document.getElementById('web').style.backgroundColor = '#1877f2';
    document.getElementById('web').style.color = 'white';
    document.getElementById('readwid').style.display = 'inLine';
